...
public class BeginnerClassMapperTest {
    ...
    public void testBeginnerClassModelIsMappedToDto() {
        ...
        woorinaru.rest.dto.management.administration.BeginnerClass beginnerClassDto = mapper.mapToDto(beginnerClassModel);
    ...
    public void testBeginnerClassDtoIsMappedToModel() {
        // GIVEN
        woorinaru.rest.dto.management.administration.BeginnerClass beginnerClassDto = new woorinaru.rest.dto.management.administration.BeginnerClass();
        ...
        assertThat(beginnerClassModel.getGrade()).isEqualTo(woorinaru.core.model.management.administration.Grade.BEGINNER);
