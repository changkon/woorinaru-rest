...
public interface IntermediateClassMapper {
    ...
    IntermediateClass mapToDto(woorinaru.core.model.management.administration.IntermediateClass intermediateClassModel);

    woorinaru.core.model.management.administration.IntermediateClass mapToModel(IntermediateClass intermediateClassDto);
