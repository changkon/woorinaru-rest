...
import woorinaru.core.model.management.administration.*;
...
public interface EventMapper {
    ...
    Event mapToDto(woorinaru.core.model.management.administration.Event eventModel);

    woorinaru.core.model.management.administration.Event mapToModel(Event eventDto);
    ...
    default Grade mapToDto(woorinaru.core.model.management.administration.Grade gradeModel) {
        switch(gradeModel) {
            case BEGINNER:
