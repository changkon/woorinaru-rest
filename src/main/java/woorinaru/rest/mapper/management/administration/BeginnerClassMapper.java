...
public interface BeginnerClassMapper {
    ...
    BeginnerClass mapToDto(woorinaru.core.model.management.administration.BeginnerClass beginnerClassModel);

    woorinaru.core.model.management.administration.BeginnerClass mapToModel(BeginnerClass beginnerClassDto);
