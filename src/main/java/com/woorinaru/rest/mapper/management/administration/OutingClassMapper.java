...
public interface OutingClassMapper {
    ...
    OutingClass mapToDto(com.woorinaru.core.model.management.administration.OutingClass outingClassModel);

    com.woorinaru.core.model.management.administration.OutingClass mapToModel(OutingClass outingClassDto);
